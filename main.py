...
# get from od with config Vars in heroku, via Settings - Reveal Config Vars, change 'sqlite:///blog.db' and '8BYkEfBA6O6donzWlSihBXox7C0sKR6b' as SECRET_KEY
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
    return render_template("post.html", date=comment_date, form=form, post=requested_post, current_user=current_user)
